...
const Ingredients: React.FC<IngredientsProps> = ({ onContinueToInstructions }) => {
  ...
  const toggleIngredient = (id: string) => {
    setIngredients(ingredients.map(ingredient => {
      if (ingredient.id === id) {
        // Toggle main ingredient and uncheck any alternatives
        return {
          ...ingredient,
  ...
  const toggleAlternative = (ingredientId: string, alternativeId: string) => {
    setIngredients(ingredients.map(ingredient => {
      if (ingredient.id === ingredientId) {
        // Determine the new state of the clicked alternative (toggle it)
        ...
        return {
          ...ingredient,
          // Unselect main ingredient when toggling alternatives
          selected: false,
